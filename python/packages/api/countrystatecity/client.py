"""Synchronous client for the Country State City API."""
...
class CountryStateCity:
    ...
    Example:
        ...
        >>> with CountryStateCity() as csc:          # reads CSC_API_KEY
        ...     for country in csc.get_countries():
    ...
    Args:
        ...
        transport: An ``httpx.BaseTransport`` to send through. Useful for tests
    ...
    def __enter__(self) -> "CountryStateCity":
    ...
    def __exit__(
        ...
        """Close the connection pool on leaving a ``with`` block."""
        self.close()
    ...
    def _data(self, endpoint: Endpoint) -> Any:
        """Send one prepared endpoint and return only the decoded body."""
        return self._send(endpoint).data
    ...
    def get_countries(
        ...
        *,
        ...
        return cast(
            List[Country],
            self._data(_endpoints.countries(q=q, fields=fields, sort=sort)),
        )
    ...
    def get_country(
        ...
        """
        return cast(Country, self._data(_endpoints.country(country, fields=fields)))
    ...
    def get_states(
        ...
        *,
        ...
        """
        return cast(
            List[State], self._data(_endpoints.states(q=q, fields=fields, sort=sort))
        )

    def get_states_of_country(
        self,
        country: Identifier,
        *,
        q: Optional[str] = None,
    ...
    def get_state(
        ...
        *,
        ...
        """
        return cast(State, self._data(_endpoints.state(country, state, fields=fields)))
    ...
    def get_regions(
        ...
        *,
        ...
        """
        return cast(
            List[Region], self._data(_endpoints.regions(q=q, fields=fields, sort=sort))
        )
    ...
    def get_region(
        ...
        Returns:
            The region record.
        """
        return cast(Region, self._data(_endpoints.region(region_id, fields=fields)))

    def get_subregions_of_region(
        self,
    ...
    def get_subregion(
        ...
        """
        return cast(
            Subregion, self._data(_endpoints.subregion(subregion_id, fields=fields))
        )

    def get_countries_of_subregion(
        self,
    ...
    def get_timezone_of_country(self, country: Identifier) -> TimezoneInfo:
        ...
        """
        return cast(TimezoneInfo, self._data(_endpoints.timezone_of_country(country)))

    def get_timezone_of_state(
        ...
        """
        return cast(
            TimezoneInfo, self._data(_endpoints.timezone_of_state(country, state))
        )

    def get_timezone_of_city(
        ...
        return cast(
            TimezoneInfo,
            self._data(_endpoints.timezone_of_city(country, state, city_id)),
        )

    # -- currencies --------------------------------------------------------

    def get_currencies(self, *, code: Optional[str] = None) -> List[CurrencyInfo]:
        ...
        """
        return cast(List[CurrencyInfo], self._data(_endpoints.currencies(code=code)))

    def get_currency_of_country(self, country: Identifier) -> CurrencyInfo:
        ...
        """
        return cast(CurrencyInfo, self._data(_endpoints.currency_of_country(country)))

    # -- phone -------------------------------------------------------------

    def get_dial_codes(self, *, code: Optional[str] = None) -> List[DialCode]:
        ...
        """
        return cast(List[DialCode], self._data(_endpoints.dial_codes(code=code)))

    def get_dial_code_of_country(self, country: Identifier) -> DialCode:
        ...
        """
        return cast(DialCode, self._data(_endpoints.dial_code_of_country(country)))

    def parse_phone_number(self, number: str) -> PhoneParsed:
        ...
        """
        return cast(PhoneParsed, self._data(_endpoints.parse_phone_number(number)))
    ...
    def lookup_state_iso(self, iso: str) -> IsoState:
        ...
        """
        return cast(IsoState, self._data(_endpoints.lookup_state_iso(iso)))
