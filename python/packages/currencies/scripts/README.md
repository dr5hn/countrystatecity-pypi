...
Generates `currencies.json` from the combined countries data source.
...
- `countrystatecity_currencies/data/currencies.json` — one entry per country with currency code, name, and symbol
